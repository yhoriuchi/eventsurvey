...
#'
#' A ready-to-use event-during-survey dataset generated by
#' [simulate_eventsurvey()] with `seed = 10`. It provides a simple first
#' example for [eventsurvey()] without requiring users to prepare or simulate
#' data before fitting a model.
#'
#' Each row represents one respondent. The event occurs at `day = 0`.
#'
#' @format A data frame with 1,496 rows and 4 variables:
#' \describe{
...
#'   \item{y}{Simulated numeric survey outcome.}
#'   \item{counterfactual}{True simulated no-event outcome for the respondent's
#'   interview day.}
#'   \item{effect}{True simulated event effect for the respondent's interview
#'   day.}
#' }
#' @source Generated with `simulate_eventsurvey(seed = 10)`.
#' @examples
